	...
	<view>
		<div class="content">
			...
			<uni-forms-item class="name" label="姓名:">
				<uni-easyinput :value="name" placeholder="请输入你的姓名" :styles="inputStyle" :disabled="isEdit"
			...
			<!-- //用于展示的两个输入框 -->
			<uni-forms-item class="requireInfo" label="班级:" v-if="isEdit">
				<uni-easyinput :value="classNo" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="requireInfo" label="性别:" v-if="isEdit">
				<uni-easyinput :value="sex" :styles="inputStyle" :disabled="isEdit" placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="requireInfo" :styles="inputStyle" label="手机号:">
				<uni-easyinput :value="phoneNum" placeholder="请输入你手机号" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="normalInfo" v-if="display" label="生日:">
				<uni-easyinput :value="birthday" placeholder="请输入你的出生年月" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="normalInfo" v-if="display" label="邮箱:">
				<uni-easyinput :value="email" placeholder="请输入你的邮箱号" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="normalInfo" v-if="display" label="微信号:">
				<uni-easyinput :value="wechat" placeholder="请输入你的微信号" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="normalInfo" v-if="display" label="QQ号:">
				<uni-easyinput :value="QQ" placeholder="请输入你的QQ号" :styles="inputStyle" :disabled="isEdit"
					placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
			<uni-forms-item class="normalInfo" v-if="display" label="个人介绍:">
				<uni-easyinput :value="resume" type="textarea" autoHeight placeholder="介绍一下自己吧~~~" :styles="inputStyle"
					:disabled="isEdit" placeholderStyle="font-size:16px">
				</uni-easyinput>
			</uni-forms-item>
